    ...
    <div className="">
      <div className="px-6 py-24 mx-auto max-w-7xl sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
        <div className="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
          <div className="flex">
            <div className="relative flex items-center px-4 py-1 text-xs leading-6 rounded-full md:text-sm text-primary gap-x-4 ring-1 ring-ring hover:ring-gray-900/20">
